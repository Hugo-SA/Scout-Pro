...
##Observações: 
- Como nesse projeto temos apenas o frontend, pode ser feito o redirecionamento (recomendamos esse passo ao invés de tentar rodar o banco fake) para um jsonfake 
https://my-json-server.typicode.com/
- Repositório foi criado apenas para desenvolver durante a aula, não tínhamos o compromisso de aplicar o git flow corretamente nele e tivemos que fazer alterações posteriormente para se adequar à continuação deste projeto (criação da API em LP3). Portanto procure a branch mais atualizada.
